...
## 成员清单
app.js: 原生 ES Module 渲染层主入口，编排文件管理、手动项目、Git 查看、预览编辑、内嵌 xterm、项目运行命令、选择性命令恢复、终端快捷动作与全局交互
...
index.html: 单页应用手动项目入口、文件区、顶栏项目运行动作、主题化隐藏文件控件、使用指南、预览区与终端区 DOM 骨架及本地 vendor 脚本加载顺序
